<section class="container-fluid py-5 py-100 sentinel-row-bg">
  <div class="row text-center text-md-start mw-1120 mx-auto align-items-center">
    <div class="col-12 col-md-7 mb-3 mb-">
