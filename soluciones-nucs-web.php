...
<div class="container-fluid responsive-tabs bg-light-secondary">
  ...
  <div class="container">
    ...
    <div id="content" class="tab-content" role="tablist">
      <div id="pane-A" class="card shadow-none tab-pane fade mb-3 show active" role="tabpanel" aria-labelledby="tab-A">
      ...
      <div id="pane-B" class="card shadow-none tab-pane fade mb-3" role="tabpanel" aria-labelledby="tab-B">
        <div class="card-header border-0 p-4 bg-light-primary rounded-2" role="tab" id="heading-B">
          <h5 class="mb-3">
            <a class="text-decoration-none" data-bs-toggle="collapse" href="#collapse-B" aria-expanded="false" aria-controls="collapse-B">
              <div class="icon-text-box">
                <div class="icon-wrapper p-2 mx-auto my-auto float-start sistemas-bancarios me-2"></div>
      ...
      <div id="pane-C" class="card shadow-none tab-pane fade mb-3" role="tabpanel" aria-labelledby="tab-C">
        <div class="card-header border-0 p-4 bg-light-primary rounded-2" role="tab" id="heading-C">
          <h5 class="mb-3">
            <a class="text-decoration-none" data-bs-toggle="collapse" href="#collapse-C" aria-expanded="false" aria-controls="collapse-C">
              <div class="icon-text-box">
                <div class="icon-wrapper p-2 mx-auto my-auto float-start sistemas-bancarios me-2"></div>
      ...
      <div id="pane-D" class="card shadow-none tab-pane fade mb-3" role="tabpanel" aria-labelledby="tab-D">
        <div class="card-header border-0 p-4 bg-light-primary rounded-2" role="tab" id="heading-D">
          <h5 class="mb-3">
            <a class="text-decoration-none" data-bs-toggle="collapse" href="#collapse-D" aria-expanded="false" aria-controls="collapse-D">
              <div class="icon-text-box">
                <div class="icon-wrapper p-2 mx-auto my-auto float-start sistemas-bancarios me-2"></div>
      ...
      <div id="pane-E" class="card shadow-none tab-pane fade mb-3" role="tabpanel" aria-labelledby="tab-E">
        <div class="card-header border-0 p-4 bg-light-primary rounded-2" role="tab" id="heading-E">
          <h5 class="mb-3">
            <a class="text-decoration-none" data-bs-toggle="collapse" href="#collapse-E" aria-expanded="false" aria-controls="collapse-E">
              <div class="icon-text-box">
                <div class="icon-wrapper p-2 mx-auto my-auto float-start sistemas-bancarios me-2"></div>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="accordion" id="accordionFlushExample">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSeven" aria-expanded="true" aria-controls="flush-collapseSeven">
              Home Banking
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseEight" aria-expanded="true" aria-controls="flush-collapseEight">
              HVIEW
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseNine" aria-expanded="true" aria-controls="flush-collapseNine">
              Laser Check
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTen" aria-expanded="true" aria-controls="flush-collapseTen">
              OnBase
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseEleven" aria-expanded="true" aria-controls="flush-collapseEleven">
              PagoCoop
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwelve" aria-expanded="true" aria-controls="flush-collapseTwelve">
              Red de Cajeros
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThirteen" aria-expanded="true" aria-controls="flush-collapseThirteen">
              Sistema Troy
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFourteen" aria-expanded="true" aria-controls="flush-collapseFourteen">
              TeleCoop
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFifteen" aria-expanded="true" aria-controls="flush-collapseFifteen">
              eLoans
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSixteen" aria-expanded="true" aria-controls="flush-collapseSixteen">
              eNCUS
            </button>
          </h2>
