...
<section class="container-lg mw-1120">
  <div class="row pt-100 pb-64 d-flex mio-bg-gradient">
    ...
    <div class="col-sm-8">
      <p>Un efecto de la recesión en el País ha sido que la morosidad en los pagos a los préstamos ha incrementado desde el 2007. Ese aumento en la morosidad ha provocado que las cooperativas de ahorro y crédito hayan tenido que aumentar las reservas para préstamos incobrables. Permítanos ayudar en el cobro de estos préstamos.
      </p>
  ...
  <div id="mobile-side-scroll" class="col d-flex flex-wrap custom-card--colecta">
    ...
    <div class="card text-center mt-md-3">
      <div class="p-4">
          ...
          <p class="my-3 light-gray-2 fs-6 text-primary fw-medium">Llamadas diarias a todos los <br/>préstamos morosos</p>
      </div>
    </div>
  </div>
</section>
