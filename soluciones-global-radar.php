...
<div class="container-fluid">
  <div class="row header-bg-img py-xl-5 py-3">
    <h1 class="text-center text-white">Global RADAR®</h1>
  </div>
</div>
...
<div class="container-lg mw-1120">
  <div class="row py-100 d-flex gx-md-5 align-items-center">
    <div class="col-sm-6">
      ...
      <p>Global RADAR® es una empresa líder con más de diez años de experiencia en servicios financieros, dedicada a ofrecer soluciones de cumplimiento y gestión de riesgos de clase mundial. Con presencia global en ocho ubicaciones estratégicas, nuestro equipo está comprometido en proporcionar programas de software de alta calidad que satisfacen las necesidades de una amplia base de clientes en más de veinte países.
      </p>
    </div>
    <div class="col-sm-6">
...
<!-- Tercer Container -->
<div class="container py-100 mw-1120">
  <div class="row text-center">
